        ...
        <div class="auth__container">
            ...
            <form @submit.prevent="handleEmailAuth" class="auth__form">
                ...
                <button
                    ...
                    :disabled="isLoadingEmail || isLoadingGoogle"
                >
                    <ButtonSpinner v-if="isLoadingEmail" class="btn__icon" />
            ...
            <button
                ...
                class="btn btn--google btn--medium btn--full-width auth__google-btn"
                :disabled="isLoadingEmail || isLoadingGoogle"
            >
                <ButtonSpinner v-if="isLoadingGoogle" class="btn__icon" />
